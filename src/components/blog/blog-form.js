...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      featured_image: "",
      apiUrl:
        "https://tarrancerichardson.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
    ...
    this.featured_image = React.createRef();
  }
  ...
  componentDidMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://tarrancerichardson.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch",
      });
    }
  }
